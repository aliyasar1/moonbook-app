 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|KrediKarti newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|KrediKarti newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|KrediKarti query()
 * @mixin \Eloquent
 */
class KrediKarti extends Model
{
    use HasFactory;
