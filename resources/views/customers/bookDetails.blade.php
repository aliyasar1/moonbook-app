...
@section('content')
    <div class="container my-5">
        <div class="row d-flex flex-column align-items-center">
                ...
                <div class="mx-4 d-block justify-content-around" style="flex: 2;">
                    ...
                    <div class="d-flex justify-content-lg-between">
                        ...
                        <p class="d-inline"><b>Yayınevi: </b> <a
                                    href="{{ route('publishingHousesBooks', $kitap->yayin_evleri->id) }}"
                    ...
                    <p><b>Satıcı: </b><a href="{{ route('sellers', $kitap->saticilar->id) }}"
            ...
            <form method="post" action="{{ route('books.addComment', $kitap->id) }}">
                @csrf
