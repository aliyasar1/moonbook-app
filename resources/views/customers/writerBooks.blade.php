...
@section('title')
    <title>MoonBook | {{ $writer->adi_soyadi }}</title>
@endsection
@section('content')
    <div class="container my-5">
        <div class="row d-flex flex-column align-items-center">
            <h2 class="mt-3">{{ $writer->adi_soyadi }}</h2>
            <hr>
                    ...
                    <div class="max-w-12xl sm:px-6 lg:px-8" style="margin-right: 5px">
                        <div class="card" style="width: 15rem; align-items: center; padding: 1.25rem;">
                            <div class="fvrt-btn bg-warning d-flex justify-content-center align-items-center">
                                <i class="@foreach($favoriteBooks as $favBook) @if($book->id === $favBook->kitap_id) fa-solid @break @else fa-regular @endif @endforeach fa-regular fa-heart"
                                   style="font-size: 18px"
                                   data-selected-value="{{ $book->id }}"></i></div>
                            ...
                            <div class="card-body p-0 w-100 text-truncate">
                                ...
                                <p class="card-text mb-2"
                                   ...
                                   title="{{ $book->yazarlar->adi_soyadi }}">{{ $book->yazarlar->adi_soyadi }}
                                    <span
