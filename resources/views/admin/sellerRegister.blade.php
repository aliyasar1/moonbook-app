...
<head>
    ...
    <title>MoonBook | Satıcı Ol</title>
    ...
    <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card o-hidden border-1 my-5">
            <div class="card-body py-5 px-3">
                ...
                <form method="post" action="{{ route('postSellerRegister') }}"
                                    ...
                                    <div class="col-lg-12 d-flex mb-3" style="justify-content: center;">
                                        <div class="ratio-1x1" style="width: 300px; height: 300px">
                                            <img
                                                ...
                                                src="{{ asset('storage/saticilar/magaza.png') }}"
                                ...
                                <div class="row d-flex flex-column align-items-center">
                                    <div class="col-lg-8">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Satıcı Ol</h1>
                                        </div>
                                        ...
                                        <div class="form-group d-flex gap-3">
                                            <div class="col px-0">
                                                <input type="text" class="form-control" id="firma_adi"
                                                       name="firma_adi" placeholder="Firma Adı">
                                                @error('firma_adi')
                                            ...
                                            <div class="col px-0">
                                                <input type="text" class="form-control" id="tckn"
                                                       name="tckn" placeholder="VKN / TCKN">
                                                @error('tckn')
                                                <div class="text-sm text-red-400" style="color: red;">
                                                    <small>{{ $message }}</small></div>
                                                @enderror
