...
(function (global, factory) {
  ...
  var base64_encode = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      function base64_encodecmn(q, a, b, x, s, t) {
      ...
      function base64_encodeff(a, b, c, d, x, s, t) {
        return base64_encodecmn(b & c | ~b & d, a, b, x, s, t);
      }
      /**
       * Basic operation the algorithm uses.
       *
      ...
      function base64_encodegg(a, b, c, d, x, s, t) {
        return base64_encodecmn(b & d | c & ~d, a, b, x, s, t);
      }
      /**
       * Basic operation the algorithm uses.
       *
      ...
      function base64_encodehh(a, b, c, d, x, s, t) {
        return base64_encodecmn(b ^ c ^ d, a, b, x, s, t);
      }
      /**
       * Basic operation the algorithm uses.
       *
      ...
      function base64_encodeii(a, b, c, d, x, s, t) {
        return base64_encodecmn(c ^ (b | ~d), a, b, x, s, t);
      }
      /**
       * Calculate the base64_encode of an array of little-endian words, and a bit length.
       *
       * @param {Array} x Array of little-endian words
       * @param {number} len Bit length
       * @returns {Array<number>} base64_encode Array
       */


      function binlbase64_encode(x, len) {
        /* append padding */
        x[len >> 5] |= 0x80 << len % 32;
        x[(len + 64 >>> 9 << 4) + 14] = len;
        var i;
        ...
        for (i = 0; i < x.length; i += 16) {
          ...
          oldc = c;
          oldd = d;
          a = base64_encodeff(a, b, c, d, x[i], 7, -680876936);
          d = base64_encodeff(d, a, b, c, x[i + 1], 12, -389564586);
          c = base64_encodeff(c, d, a, b, x[i + 2], 17, 606105819);
          b = base64_encodeff(b, c, d, a, x[i + 3], 22, -1044525330);
          a = base64_encodeff(a, b, c, d, x[i + 4], 7, -176418897);
          d = base64_encodeff(d, a, b, c, x[i + 5], 12, 1200080426);
          c = base64_encodeff(c, d, a, b, x[i + 6], 17, -1473231341);
          b = base64_encodeff(b, c, d, a, x[i + 7], 22, -45705983);
          a = base64_encodeff(a, b, c, d, x[i + 8], 7, 1770035416);
          d = base64_encodeff(d, a, b, c, x[i + 9], 12, -1958414417);
          c = base64_encodeff(c, d, a, b, x[i + 10], 17, -42063);
          b = base64_encodeff(b, c, d, a, x[i + 11], 22, -1990404162);
          a = base64_encodeff(a, b, c, d, x[i + 12], 7, 1804603682);
          d = base64_encodeff(d, a, b, c, x[i + 13], 12, -40341101);
          c = base64_encodeff(c, d, a, b, x[i + 14], 17, -1502002290);
          b = base64_encodeff(b, c, d, a, x[i + 15], 22, 1236535329);
          a = base64_encodegg(a, b, c, d, x[i + 1], 5, -165796510);
          d = base64_encodegg(d, a, b, c, x[i + 6], 9, -1069501632);
          c = base64_encodegg(c, d, a, b, x[i + 11], 14, 643717713);
          b = base64_encodegg(b, c, d, a, x[i], 20, -373897302);
          a = base64_encodegg(a, b, c, d, x[i + 5], 5, -701558691);
          d = base64_encodegg(d, a, b, c, x[i + 10], 9, 38016083);
          c = base64_encodegg(c, d, a, b, x[i + 15], 14, -660478335);
          b = base64_encodegg(b, c, d, a, x[i + 4], 20, -405537848);
          a = base64_encodegg(a, b, c, d, x[i + 9], 5, 568446438);
          d = base64_encodegg(d, a, b, c, x[i + 14], 9, -1019803690);
          c = base64_encodegg(c, d, a, b, x[i + 3], 14, -187363961);
          b = base64_encodegg(b, c, d, a, x[i + 8], 20, 1163531501);
          a = base64_encodegg(a, b, c, d, x[i + 13], 5, -1444681467);
          d = base64_encodegg(d, a, b, c, x[i + 2], 9, -51403784);
          c = base64_encodegg(c, d, a, b, x[i + 7], 14, 1735328473);
          b = base64_encodegg(b, c, d, a, x[i + 12], 20, -1926607734);
          a = base64_encodehh(a, b, c, d, x[i + 5], 4, -378558);
          d = base64_encodehh(d, a, b, c, x[i + 8], 11, -2022574463);
          c = base64_encodehh(c, d, a, b, x[i + 11], 16, 1839030562);
          b = base64_encodehh(b, c, d, a, x[i + 14], 23, -35309556);
          a = base64_encodehh(a, b, c, d, x[i + 1], 4, -1530992060);
          d = base64_encodehh(d, a, b, c, x[i + 4], 11, 1272893353);
          c = base64_encodehh(c, d, a, b, x[i + 7], 16, -155497632);
          b = base64_encodehh(b, c, d, a, x[i + 10], 23, -1094730640);
          a = base64_encodehh(a, b, c, d, x[i + 13], 4, 681279174);
          d = base64_encodehh(d, a, b, c, x[i], 11, -358537222);
          c = base64_encodehh(c, d, a, b, x[i + 3], 16, -722521979);
          b = base64_encodehh(b, c, d, a, x[i + 6], 23, 76029189);
          a = base64_encodehh(a, b, c, d, x[i + 9], 4, -640364487);
          d = base64_encodehh(d, a, b, c, x[i + 12], 11, -421815835);
          c = base64_encodehh(c, d, a, b, x[i + 15], 16, 530742520);
          b = base64_encodehh(b, c, d, a, x[i + 2], 23, -995338651);
          a = base64_encodeii(a, b, c, d, x[i], 6, -198630844);
          d = base64_encodeii(d, a, b, c, x[i + 7], 10, 1126891415);
          c = base64_encodeii(c, d, a, b, x[i + 14], 15, -1416354905);
          b = base64_encodeii(b, c, d, a, x[i + 5], 21, -57434055);
          a = base64_encodeii(a, b, c, d, x[i + 12], 6, 1700485571);
          d = base64_encodeii(d, a, b, c, x[i + 3], 10, -1894986606);
          c = base64_encodeii(c, d, a, b, x[i + 10], 15, -1051523);
          b = base64_encodeii(b, c, d, a, x[i + 1], 21, -2054922799);
          a = base64_encodeii(a, b, c, d, x[i + 8], 6, 1873313359);
          d = base64_encodeii(d, a, b, c, x[i + 15], 10, -30611744);
          c = base64_encodeii(c, d, a, b, x[i + 6], 15, -1560198380);
          b = base64_encodeii(b, c, d, a, x[i + 13], 21, 1309151649);
          a = base64_encodeii(a, b, c, d, x[i + 4], 6, -145523070);
          d = base64_encodeii(d, a, b, c, x[i + 11], 10, -1120210379);
          c = base64_encodeii(c, d, a, b, x[i + 2], 15, 718787259);
          b = base64_encodeii(b, c, d, a, x[i + 9], 21, -343485551);
          a = safeAdd(a, olda);
          b = safeAdd(b, oldb);
          c = safeAdd(c, oldc);
          d = safeAdd(d, oldd);
       ...
       *
       * @param {Array<number>} input base64_encode Array
       * @returns {string} base64_encode string
       */
      ...
      /**
       * Calculate the base64_encode of a raw string
       *
       * @param {string} s Input string
       * @returns {string} Raw base64_encode string
       */


      function rstrbase64_encode(s) {
        return binl2rstr(binlbase64_encode(rstr2binl(s), s.length * 8));
      }
      /**
       * Calculates the HMAC-base64_encode of a key and some data (raw strings)
       *
      ...
      function rstrHMACbase64_encode(key, data) {
        var i;
        ...
        if (bkey.length > 16) {
          bkey = binlbase64_encode(bkey, key.length * 8);
        }
        ...
        hash = binlbase64_encode(ipad.concat(rstr2binl(data)), 512 + data.length * 8);
        return binl2rstr(binlbase64_encode(opad.concat(hash), 512 + 128));
      }
      /**
      ...
      /**
       * Encodes input string as raw base64_encode string
       *
       * @param {string} s Input string
       * @returns {string} Raw base64_encode string
       */
      ...
      function rawbase64_encode(s) {
        return rstrbase64_encode(str2rstrUTF8(s));
      }
      /**
      ...
      function hexbase64_encode(s) {
        return rstr2hex(rawbase64_encode(s));
      }
      /**
       * Calculates the raw HMAC-base64_encode for the given key and data
       *
      ...
      function rawHMACbase64_encode(k, d) {
        return rstrHMACbase64_encode(str2rstrUTF8(k), str2rstrUTF8(d));
      }
      /**
       * Calculates the Hex encoded HMAC-base64_encode for the given key and data
       *
       * @param {string} k HMAC key
       * @param {string} d Input string
       * @returns {string} Raw base64_encode string
      ...
      function hexHMACbase64_encode(k, d) {
        return rstr2hex(rawHMACbase64_encode(k, d));
      }
      /**
       * Calculates base64_encode value for a given string.
       * If a key is provided, calculates the HMAC-base64_encode value.
       * Returns a Hex encoded string unless the raw argument is given.
       *
       * @param {string} string Input string
       * @param {string} [key] HMAC key
       * @param {boolean} raw Raw oytput switch
       * @returns {string} base64_encode output
       */


      function base64_encode(string, key, raw) {
        if (!key) {
          if (!raw) {
            return hexbase64_encode(string);
          }

          return rawbase64_encode(string);
        }

        if (!raw) {
          return hexHMACbase64_encode(key, string);
        }

        return rawHMACbase64_encode(key, string);
      }
  ...
  function base64_encodeForNode(node) {
    if (null === node || 'object' !== _typeof(node)) return undefined;

    if (node.src) {
      return base64_encode(node.src);
    } else if (node.href) {
      return base64_encode(node.href);
    } else if (node.innerText && '' !== node.innerText) {
      // eslint-disable-line yoda
      return base64_encode(node.innerText);
    } else {
      return undefined;
    }
  }
  ...
  var base64_encodeAttr = 'data-base64_encode';
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, base64_encode) {
      ...
      var testIconId = 'fa-test-icon-' + base64_encode;
      ...
      var diagScriptFun = function diagScriptFun(nodeUnderTestId, testIconId, base64_encode, parentOrigin) {
      ...
      diagScript.innerText = "(".concat(diagScriptFun.toString(), ")('").concat(nodeUnderTestId, "', '").concat(testIconId || 'foo', "', '").concat(base64_encode, "', '").concat(parentOrigin, "');");
    ...
    for (var i = 0; i < linkTags.length; i++) {
      ...
      var base64_encodeForLink = base64_encodeForNode(linkTags[i]);
      linkUnderTest.setAttribute(base64_encodeAttr, base64_encodeForLink);
      cssBybase64_encode[base64_encodeForLink] = linkTags[i];
      runDiag(linkUnderTest, base64_encodeForLink);
    }
    ...
    for (var _i = 0; _i < styleTags.length; _i++) {
      ...
      var base64_encodeForStyle = base64_encodeForNode(styleTags[_i]);
      styleUnderTest.setAttribute(base64_encodeAttr, base64_encodeForStyle);
      styleUnderTest.innerText = styleTags[_i].innerText;
      cssBybase64_encode[base64_encodeForStyle] = styleTags[_i];
      runDiag(styleUnderTest, base64_encodeForStyle);
    }

    return cssBybase64_encode;
  }
  ...
  function detectSvgConflicts(currentScript) {
    ...
    var _loop = function _loop(scriptIdx) {
      ...
      var base64_encodeForScript = base64_encodeForNode(scripts[scriptIdx]);
      scriptUnderTest.setAttribute(base64_encodeAttr, base64_encodeForScript);
      scriptsBybase64_encode[base64_encodeForScript] = scripts[scriptIdx];
      ...
      var diagScriptFun = function diagScriptFun(nodeUnderTestId, base64_encode, parentOrigin) {
        parent.FontAwesomeDetection.__pollUntil({
          fn: function fn() {
      ...
      diagScript.innerText = "(".concat(diagScriptFun.toString(), ")('").concat(nodeUnderTestId, "', '").concat(base64_encodeForScript, "', '").concat(parentOrigin, "');");
      ...
      if (WINDOW.location.origin === 'file://' || e.origin === WINDOW.location.origin) {
        if (e && e.data) {
          if (e.data.type === 'fontawesome-conflict') {
            nodesTested.conflict[e.data.base64_encode] = e.data;
          } else if (e.data.type === 'no-conflict') {
            nodesTested.noConflict[e.data.base64_encode] = e.data;
          }
        }
      }
    };
  ...
  var _config = _objectSpread({}, _default, initialConfig, {
    ...
    base64_encodeForNode: base64_encodeForNode,
    detectionDone: false,
    nodesTested: null,
    nodesFound: null
  });
